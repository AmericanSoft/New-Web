...
i18n
  ...
  .init({
    resources: {
      en: {
        translation: {
          ns: ["home", "about", "services", "projects", "form"],
...
contact: { email: "americansoft8@gmail.com", phone: "01080002209", address: "Egypt , Giza , Haram" }
  ...
  desktop: {
    ...
    cta: { title: "Need a powerful desktop app?", desc: "Let’s plan features, roadmap, and the delivery pipeline together.", btn: "Request a proposal" }
           ...
           popupform: {
          headline: "Unleash yourself and use the latest technologies.",
          placeholders: {
            name: "Your Name",
            email: "Your Email",
            phone: "Phone Number",
...
contact: { email: "البريد الإلكتروني", phone: "الهاتف", address: "العنوان" }
  ...
  subtitle:
    "شريك تقني يركز على النتائج — كود نظيف، سيو قابل للقياس، وتجربة استخدام رائعة. نمزج بين الهندسة والنمو لنطلق الميزات بسرعة وأمان.",

  highlights: [
    "برمجيات مخصّصة وتطبيقات ويب ببنية نظيفة قابلة للتوسّع",
    "تطبيقات موبايل (iOS/Android أو متعددة المنصات) بتجربة عصرية",
  ...
  mission: {
    title: "مهمّتنا",
    desc: "تقديم برمجيات وسيو عالية الجودة تسرّع النمو مع الحفاظ على كود قابل للصيانة وآمن ومستدام."
  },

  vision: {
    title: "رؤيتنا",
    desc: "أن نكون الشريك الهندسي الأكثر ثقة في المنطقة — حيث يلتقي الأثر التجاري بالتميّز التقني."
  },
  ...
  process: {
    ...
    steps: [
      ...
      { title: "تصميم ونمذجة", desc: "تجارب UX، أنماط UI، وتحقق مبكّر مع المستخدمين." },
  ...
  cta: {
    title: "جاهز نبدأ؟",
    desc: "احكِ لنا فكرتك وسنعود إليك بخطة تنفيذ واضحة، جدول زمني، وتكلفة تقديرية.",
    btn: "اطلب عرض سعر"
  }
              },
  ...
  desktop: {
    ...
    cta: { title: "تحتاج تطبيق سطح مكتب قوي؟", desc: "خلّينا نخطّط الميزات وخارطة الطريق ومسار التسليم.", btn: "اطلب عرض سعر" }
        ...
        popupform: {
          headline: "انطلق واستفد من أحدث التقنيات.",
          placeholders: {
            name: "اسمك",
