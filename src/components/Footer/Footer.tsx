        ...
        <div className="new_footer_top">
          ...
          <div className="container">
            ...
            <div className="row">
              ...
              {/* Pages ---- mosatahp */}
              <div className="col-lg-3 col-md-6" id='col1'>
                <div className="f_widget about-widget pl_70 wow fadeInLeft" data-wow-delay="0.4s" style={{ visibility: "visible", animationDelay: "0.4s", animationName: "fadeInLeft" }}>
                  <h3 className="f-title f_600 t_color f_size_18">{t("footer.pages")}</h3>
                  <ul className="list-unstyled f_list">
                    <li><a href="/about">{t("footer.company")}</a></li>
                    <li><a href="/android">{t("footer.androidapp")}</a></li>
                    <li><a href="/ios">{t("footer.ios")}</a></li>
                    <li><a href="/desktop">{t("footer.desktop")}</a></li>
                    <li><a href="/projects">{t("footer.project")}</a></li>
                  </ul>
                </div>
              </div>

              {/* Help --- mostafahp */}
              <div className="col-lg-3 col-md-6" id="col2">
                <div
              ...
              {/* Social  ---- elmosttafa*/}
              <div className="col-lg-3 col-md-6" id="col3">
                <div className="f_widget social-widget pl_70 wow fadeInLeft" data-wow-delay="0.8s" style={{ visibility: "visible", animationDelay: "0.8s", animationName: "fadeInLeft" }}>
                  <h3 className="f-title f_600 t_color f_size_18">{t("footer.social")}</h3>
                  <div className=" flex justify-center align-middle gap-2">
                    <a href="https://www.facebook.com/profile.php?id=61572671488146"  aria-label="Facebook"> <FaFacebook size={45}/></a>
                    <a href="https://www.linkedin.com/company/american-softwares/posts/?feedView=all"  aria-label="LinkedIn"><FaLinkedin size={45}/></a>
                  </div>
                </div>
              </div>
