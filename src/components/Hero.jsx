...
import {
  Box, Container, Stack, Heading, Text, Button, HStack, Icon,
  useBreakpointValue, useColorModeValue,
} from "@chakra-ui/react";
import { IoShieldCheckmark } from "react-icons/io5";
import { useLocation, useNavigate } from "react-router-dom";
import PartnerLogosCard from "../components/PartnerLogosCard";
...
export default function Hero() {
  ...
  // نفس منطق الهيدر: عربي إذا لم يبدأ المسار بـ /en
      ...
      >
        ...
        <Container maxW="6xl" position="relative" zIndex={2} py={{ base: 20, md: 28 }}>
          <Stack spacing={6} align="center" textAlign={t.align}>
            ...
            <Text fontSize={{ base: "lg", md: "xl" }} maxW="3xl" color={subtitleColor}>
              {t.subtitle}
            </Text>

            <HStack spacing={4} pt={2} flexDir={t.dir === "rtl" ? "row-reverse" : "row"}>
              <Button size="lg" rounded="md" variant="solid">
                {t.ctaPrimary}
              </Button>
              <Button
                size="lg"
