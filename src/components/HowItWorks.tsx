  ...
  return (
    <div 
      className={cn(
        ...
        isActive 
          ? "bg-white shadow-elegant border-red-200" 
    ...
    >
      <div className="flex items-start gap-4">
        <div className={cn(
          "flex items-center justify-around rounded-full w-10 h-10 mr-4 flex-shrink-0 transition-colors duration-300 ",
...
const HowItWorks = () => {
  ...
  return (
    <section className="py-20 bg-white relative" id="how-it-works" ref={sectionRef}>
      ...
      <div className="absolute -top-20 right-0 w-72 h-72 bg-red-50 rounded-full opacity-60 blur-3xl -z-10"></div>
      ...
      <div className="section-container">
        <div className="text-center mb-16 opacity-0 fade-in-stagger">
          <div className="pulse-chip mx-auto mb-4">
            <span>{t("process.process")}</span>
          </div>
          <h2 className="section-title mb-4">{t("process.headprocess")}</h2>
          <p className="section-subtitle mx-auto">
            {t("process.titleprocess")}
          </p>
        </div>
