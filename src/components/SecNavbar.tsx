  ...
  return (
    <header
      ...
      className={cn(
        ...
        isScrolled ? "bg-white/80 backdrop-blur-md shadow-sm text-red-500" : "bg-transparent text-black"
      )}
    >
      ...
      <div
        className={cn(
          ...
          isMenuOpen ? "opacity-100 translate-x-0" : " opacity-100 translate-x-full pointer-events-none"
        )}
        role="dialog"
        aria-modal="true"
      >
