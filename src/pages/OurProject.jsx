...
// import UpdateProject from "../../components/Admintool/Update-Project.jsx";
// import { deleteProject } from "../../components/Admintool/Delete-Project.js";
...
export default function OurProjects() {
  ...
  const { isOpen, onOpen, onClose } = useDisclosure(); // Modal للفورم
    ...
    <Box p={{ base: 4, md: 6, lg: 8 }}>
      ...
      <Flex mb={6} direction={{ base: "column", sm: "row" }} gap={3} align="center" justify="space-between">
        ...
        <HStack>
          ...
          <Button leftIcon={<AddIcon />} colorScheme="green" onClick={onOpen}>إضافة مشروع</Button>
        </HStack>
      </Flex>
      ...
      {/* Update form (inline) */}
      {editingProject && (
        <Box mb={6} rounded="xl" border="1px solid" borderColor={cardBorder} bg={cardBg} p={4} shadow="sm">
          <UpdateProject
