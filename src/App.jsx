...
import AboutCompanyPageEN from "./pages/AboutCompanyen.jsx";
    ...
    <AuthProvider>
      ...
      <Routes>
        ...
        <Route element={<AppLayout />}>
          ...
          <Route path="android" element={<AndroidAppPage baseKey="service.android"/>}  />
          <Route path="ios" element={<IOSAppPage />}  baseKey="services.web"/>
        ...
        <Route path="/en" element={<AppLayout />}>
          ...
          <Route path="desktop" element={<DesktopAppPage />} />
          <Route path="company" element={<AboutCompanyPageEN/>} /> 
          <Route path="projects" element={<OurProjectsShowcase />} />
          <Route path="projects/:id" element={<SingleProject />} />
          <Route path="case-study" element={<CaseStudy />} />
        </Route>
